...
import { Field, QueryResult, FieldOverrideState, UserChartType, DistributionVariant, TableCellMode, TooltipField, LineVariant, DensityParams, ColorChannel, MapExtentMode, MapViewBounds } from '../types';
...
export interface ChartGenerationContext {
  ...
  /** Transient pan/zoom view overrides keyed by map plot cell id. */
