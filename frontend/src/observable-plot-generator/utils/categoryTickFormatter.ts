...
export function buildCategoryTickFormatter(axis: 'x' | 'y', maxChars = MAX_CATEGORY_TICK_CHARS[axis]) {
  return (value: unknown): string => truncateCategoryTick(normalizeCategoryTickValue(value), maxChars);
}
