    ...
    fields.push(
      {
        ...
        value: formatTooltipValue(row.min, valueField),
        formattedValue: formatTooltipValue(row.min, valueField),
        sourceField: valueField,
        rawValue: row.min,
      },
      {
        label: `${valueLabel} Q1`,
        value: formatTooltipValue(row.q1, valueField),
        formattedValue: formatTooltipValue(row.q1, valueField),
        sourceField: valueField,
        rawValue: row.q1,
      },
      {
        label: `${valueLabel} median`,
        value: formatTooltipValue(row.median, valueField),
        formattedValue: formatTooltipValue(row.median, valueField),
        sourceField: valueField,
        rawValue: row.median,
      },
      {
        label: `${valueLabel} Q3`,
        value: formatTooltipValue(row.q3, valueField),
        formattedValue: formatTooltipValue(row.q3, valueField),
        sourceField: valueField,
        rawValue: row.q3,
      },
      {
        label: `${valueLabel} max`,
        value: formatTooltipValue(row.max, valueField),
        formattedValue: formatTooltipValue(row.max, valueField),
        sourceField: valueField,
        rawValue: row.max,
      },
      {
