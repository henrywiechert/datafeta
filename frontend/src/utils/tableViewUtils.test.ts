...
describe('shouldUseTableView', () => {
  ...
  it('returns false for all-discrete shapes when no chart type is picked (legacy table retired)', () => {
  ...
  it('still returns false on all-discrete shapes when globalChartType is null/undefined (legacy table retired)', () => {
